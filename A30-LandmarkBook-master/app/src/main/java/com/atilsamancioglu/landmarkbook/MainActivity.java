...
public class MainActivity extends AppCompatActivity {
    ...
    private ActivityMainBinding binding;//view binding ilk adımı build.gradle içerisinde view binding true yapıldı
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //view binding yapmak için gerekli olan satırlar
        ...
        setonitemclicklistener demek bir adet itema tıklanınca ne olacağı anlamına geliyor
            @Override
